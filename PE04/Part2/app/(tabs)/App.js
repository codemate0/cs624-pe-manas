// PE04 Part 2 - Profile Card gallery using flexbox
...
// Six profile cards, each with its own independent state
const data = Array.from({ length: 6 }, () => ({ ...profile }));
...
const styles = StyleSheet.create({
  // Section 5.3 flexbox - lays the six cards out in a wrapped grid
  container: {
    flex: 1,
    flexDirection: 'row',
    flexWrap: 'wrap',
